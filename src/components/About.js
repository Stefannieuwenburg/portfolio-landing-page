...
export default function About() {
    return (
        <section>
            ...
            <br />
            Ik ben Full Stack web Developer. ik werk graag met moderne
            ...
            een nieuwe React web site kunnen gebruiken. het liefst werk ik in
            klein team verband zo kan je veel en snel van elkaar leren. ook vind
            ik het erg leuk om in de nieuwen technieken te duiken zo als Vite en
